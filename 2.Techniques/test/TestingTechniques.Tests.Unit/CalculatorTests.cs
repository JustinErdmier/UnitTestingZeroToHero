...
public class CalculatorTests
{
    ...
    [ Theory, InlineData(5, 5, 10), InlineData(-5, 5, 0), InlineData(-15, -5, -20) ]
    ...
    [ Theory, InlineData(5, 5, 0), InlineData(15, 5, 10), InlineData(-5, -5, 0), InlineData(-15, -5, -10), InlineData(5, 10, -5) ]
    ...
    [ Theory, InlineData(5, 5, 1), InlineData(15, 5, 3) ]
